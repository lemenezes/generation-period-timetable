...
namespace PeriodicTimetableGeneration
{
    ...
    public class GenerationAlgorithmPESP
    {
        ...
        public PropagationResult runPreparationAlgorithm(IConstraintPropagator propagator)
        {
			...
			return propagator.runPropagationAlgorithm(constraints, GenerationAlgorithmPESPUtil.MODULO_DEFAULT);
        }
