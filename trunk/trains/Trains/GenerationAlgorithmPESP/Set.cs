...
namespace PeriodicTimetableGeneration
{
    ...
    public class Set : ISet
    {
        ...
        /// <summary>
        /// Hastable for set and its appropriate minimization factor value.
        /// </summary>
        ...
        /// <summary>
        /// Gets the content of minimization factor.
        /// </summary>
        /// <returns>Minimization factor.</returns>
        ...
        /// <summary>
        /// Creates the minimization factor for all items of set.
        /// </summary>
        ...
        public void Reverse()
        {
            ...
            foreach (int item in this.mySet)
            {
                ...
                // change a key in minimalizaion factor hashtable, where the item is a key
        ...
        public static Set Addition(Set oneSet, Set otherSet)
        {
            ...
            {
                newSet.AddRange(GenerationAlgorithmPESPUtil.createSequenceOfNumber(oneSet.Modulo));
                return newSet;
            }
            ...
            foreach (int item1 in oneSet.DiscreteSet)
                foreach (int item2 in otherSet.DiscreteSet)
                {
                    ...
                    // calculate the new factor, NOT NEEDED a MinFactor
                    /*
        ...
        /// <summary>
        /// Gets or sets the minimization factor.
        /// </summary>
        /// <value>The minimization factor.</value>
        ...
        /// <summary>
        /// Changes the key in minimization factor into newKey and remain the same value.
        /// </summary>
